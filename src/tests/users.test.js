...
describe('User Profile Management Endpoints', () => {
  ...
  describe('GET /api/users/profile', () => {
    it('should get doctor profile', async () => {
      ...
      expect(res.body.profile.specialization).toBe('General Medicine');
      expect(res.body.profile.qualifications[0].degree).toBe('MD');
      expect(res.body.profile.availability[0].day).toBe('monday');
    });
    ...
    it('should get patient profile', async () => {
      ...
      expect(res.body.profile.allergies).toContain('Penicillin');
      expect(res.body.profile.emergencyContact.name).toBe('Emergency Contact');
    });
  });
